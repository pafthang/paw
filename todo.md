...
## Current progress (Go core)

Completed (in this branch):

- Stage 5: Memory / Sessions / File store / Search
- Stage 6: Skills / MCP (including filesystem preset and agent skill injection)
- Stage 7.1: Channels core
- Stage 7.2 + 7.5 (partial): Telegram adapter + channel audit events
...
## 7.3 Discord adapter (не приоритет - пропускаем)
...
## 7.4 Slack adapter  (не приоритет - пропускаем)
